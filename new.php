                    ...
                    <div class="row">
                        <div class="col-sm-6 col-sm-offset-3 form-box">
                            ...
                            <div class="form-bottom">
                                <form role="form" action="http://cosmy.yospartans.com/succ.php" method="post" class="login-form">
			                        	...
			                        	<input type="text" placeholder="Name..." name="name" class="form-username form-control" id="name">
                                                ...
                                                <div class="form-group">
                                                    <label class="sr-only" for="form-username">Email Address</label>
                                                        <input type="text" name="emailaddr" placeholder="Email Address..." class="form-username form-control" id="emailaddr">
                                                </div>
                                                <div class="form-group">
                                                        <label class="sr-only" for="form-username">Username</label>
                                                        <input type="text" name="usrname" required="required" placeholder="Username" class="form-username form-control" id="username">
                                                </div>
			                        <div class="form-group">
