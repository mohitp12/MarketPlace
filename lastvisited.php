...
$db = new mysqli('yospartanscom1.fatcowmysql.com', 'mohit', 'admin', 'cosmy');
...
<!-- Section Background -->
	<section class="section-background">
        ...
        <a href="#" style="text-decoration: none"><h2 class="section-title black">
				Last Visited
            </h2> <!-- /.section-title --></a>
...
?>
                ...
                <?php $product = $db->query("SELECT products.id, products.product_name, products.product_price, AVG(product_rating.rating_value) AS rating FROM products LEFT JOIN product_rating ON products.id = product_rating.product_id WHERE products.id = {$value}")->fetch_object(); ?>
                            
				<div class="col-sm-4 col-xs-6">
					<div class="portfolio-item">
						<div class="portfolio-img">
                                                    <img src="assets/images/p<?php echo $value; ?>.jpg"  style="width: 300px; height: 350px;" alt="port-1" class="port-item">
							<div class="portfolio-img-hover">
								<a href="portfolio.php?id=<?php echo $value; ?>"><img src="assets/images/plus.png" alt="plus" class="plus"></a>
